...
public class UniformResult
{
    ...
    public static int DefaultErrorCode = (int)ExceptionCode.Unknown;
    ...
    public static UniformResult Error(ExceptionCode errorCode, string message) => new() { Success = false, ErrorCode = (int)errorCode, Message = message, Data = null };

    public static UniformResult Error(int errorCode) => new() { Success = false, ErrorCode = errorCode, Message = "", Data = null };
    public static UniformResult Error(ExceptionCode errorCode) => new() { Success = false, ErrorCode = (int)errorCode, Message = "", Data = null };
